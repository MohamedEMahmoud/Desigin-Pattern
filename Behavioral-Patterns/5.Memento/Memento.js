var Originator = /** @class */ (function () {
    ...
    Originator.prototype.generateRandomString = function (length) {
        ...
        return Array.apply(null, { length: length }).map(function () { return charSet.charAt(Math.floor(Math.random() * charSet.length)); }).join('');
    };
...
var Caretaker = /** @class */ (function () {
    ...
    Caretaker.prototype.showHistory = function () {
        ...
        for (var _i = 0, _a = this.mementos; _i < _a.length; _i++) {
            var memento = _a[_i];
            console.log(memento === null || memento === void 0 ? void 0 : memento.getName());
        }
    };
    return Caretaker;
}());
